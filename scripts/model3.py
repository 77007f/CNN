...
num_epochs = 60 # we iterate 25 times over the entire training set
kernel_size = 3 # we will use 3x3 kernels throughout
pool_size = 6 # we will use 2x2 pooling throughout
conv_depth_1 = 10 # we will initially have 32 kernels per conv. layer...
conv_depth_2 = 15 # ...switching to 64 after the first pooling layer
conv_depth_3 = 20
drop_prob_1 = 0.50 # dropout after pooling with probability 0.25
drop_prob_2 = 0.50 # dropout in the FC layer with probability 0.5
hidden_size = 40 # the FC layer will have 512 neurons
##########################################################################
